<template>
    <div class="app-container">
        ...
        <el-form  :inline="true" class="demo-form-inline">
            <el-form-item class="search" label="手机号">
                <el-input v-model="searchObj.phone" placeholder="手机号"/>
            </el-form-item>
            <el-form-item class="search" style="margin-left:10px" label="认证状态">
                <el-select
        ...
        <br>
            ...
            <el-button style="margin-left:20px" type="primary"  @click="fetchData()">查询</el-button>
        ...
        stripe
            ...
            <el-table-column prop="updateTime" width="100" label="修改时间"/>
...
export default {
    ...
    data() {
        return {
            ...
            limit: 10, // 每页记录数
            searchObj: {}, // 查询表单对象
            authStatusList:[{"name":"未认证","value":0},{"name":"认证中","value":1},{"name":"认证成功","value":2},{"name":"认证失败","value":-1}], //0：未认证 1：认证中 2：认证成功 -1：认证失败
        }
    },
    // 当页面加载时获取数据
    created() {
    ...
    // 调用api层获取数据库中的数据
        fetchData(page = 1) {
            ...
            // 异步获取远程数据（ajax）
            this.page = page
            userInfo.getUserInfoList(this.page, this.limit, this.searchObj)
                .then(response => {
